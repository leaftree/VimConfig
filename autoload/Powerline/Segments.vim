let g:Powerline#Segments#segments = Pl#Segment#Init([
	...
	\ Pl#Segment#Create('filetype'        , '%{strlen(&ft) ? &ft : "NO FORMATE"}', Pl#Segment#Modes('!N')),
	\ Pl#Segment#Create('ASCII'			  , '[ASCII=%03.3b]'),
	\ Pl#Segment#Create('HEX'			  , '[HEX=%02.2B]'),
	\ Pl#Segment#Create('scrollpercent'   , '[%03p%%]'),
	\ Pl#Segment#Create('lineinfo',
		\ Pl#Segment#Create('line.cur'    , '$LINE %4l'),
